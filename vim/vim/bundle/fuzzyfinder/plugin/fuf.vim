...
function s:initialize()
  "---------------------------------------------------------------------------
  call l9#defineVariableDefault('g:fuf_modesDisable'     , [ ])
"  call l9#defineVariableDefault('g:fuf_modesDisable'     , [ 'mrufile', 'mrucmd', ])
  ...
  call l9#defineVariableDefault('g:fuf_enumeratingLimit' , 200)
  ...
  call l9#defineVariableDefault('g:fuf_buffer_keyDelete'  , '<C-d>')
  "---------------------------------------------------------------------------
  ...
  call l9#defineVariableDefault('g:fuf_coveragefile_globPatterns', ['**/configure', '**/Makefile', '**/*.c', '**/*.h', '**/*.vim', '**/*.sh', '**/*.zsh', '**/*.py', '**/*.rb', '**/*.pl', '**/*.lua', '**/*.tex'])
  "---------------------------------------------------------------------------
  ...
  call l9#defineVariableDefault('g:fuf_bookmarkfile_keyDelete'  , '<C-d>')
  "---------------------------------------------------------------------------
  ...
  call l9#defineVariableDefault('g:fuf_bookmarkdir_keyDelete'  , '<C-d>')
  "---------------------------------------------------------------------------
